...
class DrugBank:
    ...
    def __init__(self, filename, ids, id_types, names):
        ...
        self.get_ids = {'cas-number': self.cas_number, 'ChEBI': self.chebi, 'ChEMBL': self.chembl, 'drugbank-id': self.drugbank, 'InChIKey': self.inchikey, 'PubChem Compound': self.pubchem_compound, 'PubChem Substance': self.pubchem_substance, 'unii': self.unii}
